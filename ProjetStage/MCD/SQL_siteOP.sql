...
CREATE TABLE IF NOT EXISTS `siteOP`.`figurine` (
  ...
  `descriptionFigurine` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`dvdBluray` (
  ...
  `descriptionDvd` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`vetement` (
  ...
  `descriptionVetement` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`goodie` (
  ...
  `descriptionGoodie` VARCHAR(255) NOT NULL,
