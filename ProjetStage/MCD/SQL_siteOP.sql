...
CREATE TABLE IF NOT EXISTS `siteOP`.`Adresse` (
  ...
  `AdresseComplementaire` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`Utilisateur` (
  ...
  `telUti` INT NOT NULL,
  `Type Utilisateur_idTypeUtilisateur` INT NOT NULL,
  `Adresse_idAdresse` INT NOT NULL,
  PRIMARY KEY (`idUtilisateur`),
  UNIQUE INDEX `idUtilisateur_UNIQUE` (`idUtilisateur` ASC) VISIBLE,
  INDEX `fk_Utilisateur_Type Utilisateur1_idx` (`Type Utilisateur_idTypeUtilisateur` ASC) VISIBLE,
  INDEX `fk_Utilisateur_Adresse1_idx` (`Adresse_idAdresse` ASC) VISIBLE,
  CONSTRAINT `fk_Utilisateur_Type Utilisateur1`
    FOREIGN KEY (`Type Utilisateur_idTypeUtilisateur`)
    REFERENCES `siteOP`.`Type Utilisateur` (`idTypeUtilisateur`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
