...
CREATE TABLE IF NOT EXISTS `siteOP`.`figurine` (
  ...
  `descriptionFigurine` TEXT(10000) NOT NULL,
  `prixFigurine` DECIMAL(5,2) NOT NULL,
  `imageFigurine` VARCHAR(255) NOT NULL,
  `image2Figurine` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`livre` (
  ...
  `descriptionLivre` TEXT(10000) NOT NULL,
  `prixLivre` DECIMAL(5,2) NOT NULL,
  `imageLivre` VARCHAR(255) NOT NULL,
  `image2Livre` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`dvdBluray` (
  ...
  `descriptionDvd` TEXT(10000) NOT NULL,
  `prixDvd` DECIMAL(5,2) NOT NULL,
  `imageDvd` VARCHAR(255) NOT NULL,
  `image2Dvd` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`vetement` (
  ...
  `descriptionVetement` TEXT(10000) NOT NULL,
  `prixVetement` DECIMAL(5,2) NOT NULL,
  `tailleVetement` VARCHAR(255) NULL,
  `imageVetement` VARCHAR(255) NOT NULL,
  `image2Vetement` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `siteOP`.`goodie` (
  ...
  `descriptionGoodie` TEXT(10000) NOT NULL,
  `prixGoodie` DECIMAL(5,2) NOT NULL,
  `imageGoodie` VARCHAR(255) NOT NULL,
  `image2Goodie` VARCHAR(255) NULL,
