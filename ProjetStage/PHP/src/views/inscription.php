...
if (isset($_POST['nom']) ) {
    ...
    $user->setEmailUti($email);
    $emailExist=$user->verifEmail();
...
*/
    if ($emailExist) {
        ...
        $reqUtilisateur->bindParam(":uti6", $idAdd);
...
?>
    <div><h4 class="d-flex justify-content-center mt-3">IDENTIFIEZ-VOUS</h4>
        <hr style="width:80%;background-color:#333F50;border-width: 1px">
    </div>
        ...
        <div class="col-xs-6 col-sm-6 col-md-4  col-lg-4  col-xl-4 ">
            <div class="card">
                <div class="card-body" style="border:1px solid #333F50;">
                    ...
                    <hr style="background-color:#333F50;border-width: 1px">
                    <form method="post" action="inscription.php">
                        ...
                        <div class=" mb-2 d-flex justify-content-between">
                            <input type="text" class="form-control w-45" name="prenom" id="prenom" placeholder=""
                                   required>
                ...
                <div class=" mb-2 d-flex justify-content-between">
                    ...
                    <input type="text" class="form-control w-45" name="adresseComplementaire" id="adresseComplementaire"
                ...
                <div class=" mb-2  d-flex justify-content-between ">
                    <input type="text" class="form-control w-25  label" id="codePostal" name="codePostal" placeholder=""
                           required>
                ...
                <div class=" mb-2  d-flex justify-content-between ">
                    ...
                    <input type="email" class="form-control w-45" name="email" id="email" aria-describedby="emailHelp"
                           placeholder="">
                ...
                <div class="mb-2 d-flex justify-content-between">
                    <input type="password" id="mdp" name="mdp" class="form-control w-45"
                           aria-describedby="passwordHelpBlock">
                    <input type="password" id="confMdp" name="confMdp" class="form-control w-45"
                           aria-describedby="passwordHelpBlock">
                </div>
                <div class="mb-3">
                    <small>Au moins une majuscule et 6 caractères</small>
                </div>
                <button type="submit" id="btnInscription" class="btn bg-bluedark text-light mt-3">Creez votre compte
                </button>
                </form>
            </div>
        </div>
            ...
            <div class="card-body" style="border:1px solid #333F50;">
                ...
                <form method="post" action="inscription.php">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control " id="email" name="emailConnex"
